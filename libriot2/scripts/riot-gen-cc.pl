...
# ldplfs mpicc script to mimic it's behavior
...
$link_cmd =~ s/foo.o -o foo/"\$\{newallargs\[\@\]\}" -L$UP{RIOT_LIB_PATH} -lriot $FUNCTION_WRAPPERS/g;
...
#!/bin/bash
#
# Auto-generated mpicc script from ldplfs-gen-cc.pl
#
#
# Internal variables
...
Purpose:
    ...
    modified version that includes RIOT support.
